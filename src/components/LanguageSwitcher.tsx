...
export function LanguageSwitcher({ language, onChange }: Props) {
  return (
    <div className="fixed bottom-[calc(1rem+env(safe-area-inset-bottom))] right-[max(1rem,env(safe-area-inset-right))] z-[60] rounded-full border border-[#c8e0d5] bg-white/90 p-1 shadow-lg backdrop-blur-xl md:bottom-5 md:right-5">
